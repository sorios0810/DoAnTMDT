...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "Nguyễn Lê Hùng Anh";
        ...
        type = ResourceType.Add( "Ảnh đồng hồ" );
        type.Url = BaseUrl + "ImagesWatch/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesWatch/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh trang sức" );
        type.Url = BaseUrl + "ImagesJewel/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesJewel/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
